...
description: Manage Docker containers, images, volumes, networks, and Docker Compose services. Use for running, stopping, inspecting, and debugging containers; building, pulling, tagging, and cleaning up images; orchestrating multi-service stacks with docker compose; managing volumes and networks; troubleshooting crashes, analyzing logs, and optimizing Dockerfiles. Trigger whenever the user mentions Docker, containers, images, Dockerfile, docker-compose, or describes running services in containers, port mapping, or container orchestration — even casually like "my container keeps crashing", "clean up old images", or "spin up a postgres with redis".
version: 1.0.0
author: sprmn24
license: MIT
metadata:
